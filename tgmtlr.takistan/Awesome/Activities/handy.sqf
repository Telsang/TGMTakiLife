...
private ["_item","_anzahl","_smstext","_smsplayernumber","_smsplayer","_moneh","_art"];
_art = _this select 0;
...
if ((%2 == player) and (_mobile > 0)) then {titletext [format [localize "STRS_inv_item_handy_nachricht", "%1", %3], "plain"]; player commandchat format [localize "STRS_inv_item_handy_nachricht", "%1", %3];};
