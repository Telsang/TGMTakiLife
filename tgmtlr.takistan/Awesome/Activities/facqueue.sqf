...
private ["_id","_arr","_queue","_fqueue","_moneh","_workers","_i","_list"];
if(typename _this == "ARRAY") exitwith
	...
	if(_moneh < facworkercost)exitwith{player groupchat "you do not have enough money"};

	["money", -facworkercost] call INV_AddInventoryItem;
...
_arr 		= (INV_ItemFactories select _this);
_queue	 	= (_arr select 8);
_list		= _arr select 5;
